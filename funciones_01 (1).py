...
Original file is located at
    https://colab.research.google.com/drive/1ifrliqPUXD9B1VRQ-DUSNvYtSnf-AiTN
...
def display_message():
   print ("Los temas vistos hasta el momento son: Funciones sin argumentos y funciones con argumentos")
display_message()

def libro_favorito(titulo):
   print ("Tu libro favorito es "+ str(titulo))
libro_favorito("gestion ambiental")
...
def hacerPlayera(talla,texto):
   print("La playera es talla "+talla+" y el texto a serigrafear es "+texto)
...
def hacerPlayera(talla="grande",texto="yo <3 Python"):
   print("La playera es de talla " + talla + " y el texto a serigrafear es "+ texto)

hacerPlayera()
hacerPlayera(talla="mediana")
hacerPlayera(talla="chica",texto="IPN de <3")
...
descripcionCiudad("Xalapa")
descripcionCiudad("Río de Janerio","Brazil")
descripcionCiudad("París","Francia")
descripcionCiudad("Monterrey")
descripcionCiudad("Cancún")
descripcionCiudad("Barcelona","España")
...
n=int(input("Introduzca el numero de renglones "))
for i in range(n+1):
    print("+"*i)
